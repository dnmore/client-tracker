...
export function Sidebar() {
  ...
  return (
    <aside
      className="flex h-full w-16 flex-col border-r bg-background md:w-64"
      aria-label="Sidebar"
    >
      <div className="flex h-14 items-center justify-center border-b md:justify-start md:px-6">
        <HugeiconsIcon icon={ThreeDRotateIcon} className="m-4 h-8 w-8" />
      </div>
            ...
            const link = (
              <Link
                ...
                className={clsx(
                  ...
                  {
                    "font-bold bg-muted": pathname === href,
                  },
                )}
              >
                <HugeiconsIcon
